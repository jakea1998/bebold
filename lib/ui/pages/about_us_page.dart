     ...
     appBar: AppBar(
      ...
      body: SafeArea(child: Column(
        ...
        const Padding(
           ...
           Padding(
             ...
             child: RichText(
                          ...
                          fontWeight: FontWeight.w900),
                                  ...
                                  TextSpan(
                                  text: ' app was created to assist Believers, Churches, Missionaries, and Evangelism Teams in sharing the love of God and the gift of Jesus with the world.',
                                  style: TextStyle(color: Colors.black,fontSize: 16,
                          fontWeight: FontWeight.w500),
                                ),
           ...
           Padding(padding: const EdgeInsets.symmetric(vertical: 0,horizontal: 20),child: RichText(
                            text:  TextSpan(
                              children: [
                                const TextSpan(
                                  text: '\nPlease visit:  ',
