  ...
  Widget build(BuildContext context) {
    ...
    Spacer(flex: 1,),
        ...
        ExpandableTab(
          ...
          body: Column(children: [
            const ExpandableTab(title: "Just For You", body: Column(
              children: [
                  Padding(
                    padding: EdgeInsets.all(8.0),
                    child: Text.rich(
    ...
    TextSpan(
      children: [
        ...
        const TextSpan(text: 'Father, in the Name of Jesus, I pray for '),
        TextSpan(text: "${getUnderlineString(length:20)}",style: const TextStyle(decoration: TextDecoration.underline)),
        const TextSpan(
        ...
        const TextSpan(text: 'The gospel of Jesus Christ is no longer hidden from '),
        TextSpan(text: "${getUnderlineString(length:15)}",style: const TextStyle(decoration: TextDecoration.underline)),
        const TextSpan(text: '.  '),
           TextSpan(text: "${getUnderlineString(length:15)} ",style: const TextStyle(decoration: TextDecoration.underline)),
            const TextSpan(text: 'will know and experience Jesus and His sacrifice for him/her.\n\n'),
           const TextSpan(text: 'Father, because you always hear me when I pray, I know that you have answered my prayer.  From this day forward, I thank you that '),
           TextSpan(text: "${getUnderlineString(length:15)} ",style: const TextStyle(decoration: TextDecoration.underline)),
        const TextSpan(text: 'is saved and is in right standing with you.  Amen.\n\n'),
         const TextSpan(
            text: 'Scriptures to Pray Over the Unsaved:\n',
            style: TextStyle(fontWeight: FontWeight.bold)),
        const TextSpan(text: '2 Corinthians 4:3-4, Matthew 9:37-38'),
      ],
    ),
  ),
                  )
    ...
    TextSpan(
      children: [
        ...
        const TextSpan(text: 'Father, in the Name of Jesus, I pray for '),
        TextSpan(text: "${getUnderlineString(length:15)}",style: const TextStyle(decoration: TextDecoration.underline)),
        const TextSpan(text: ".  I ask that you fill ",),
        TextSpan(text: "${getUnderlineString(length:15)} ",style: const TextStyle(decoration: TextDecoration.underline)),
        
        const TextSpan(text: 'with the knowledge of your will in all wisdom and spiritual understanding.  I pray the eyes of his/her understanding be enlightened and that he/she may know what is the hope of your calling.  I also ask that '),
          TextSpan(text: " ${getUnderlineString(length:15)} ",style: const TextStyle(decoration: TextDecoration.underline)),
        const TextSpan(text: ' knows his/her inheritance as saints and the exceeding greatness of your power towards him/her according to Ephesians 1:16-20.'),
      ],
    ),
  ),
                  )
